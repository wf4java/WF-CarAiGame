...
//        rendTH.stop();
    ...
    public void addMouseDraggedListener(MouseDraggedListener ms) { mouseDraggedListeners.add(ms); }
    public void addMousePressedListener(MousePressedListener ms) { mousePressedListeners.add(ms); }
